 ...
 */
registerRoute(({ url }) => url.hostname === 'build.protomaps.com' ||
    url.pathname.endsWith('.pmtiles'), new CacheFirst({
 ...
 */
registerRoute(({ url }) => url.hostname === 'tiles.openseamap.org', new CacheFirst({
 ...
 */
registerRoute(({ url }) => url.hostname === 'protomaps.github.io', new CacheFirst({
 ...
 */
registerRoute(({ url }) => url.hostname === 'fonts.googleapis.com' ||
    url.hostname === 'fonts.gstatic.com', new StaleWhileRevalidate({
 ...
 */
registerRoute(({ url }) => url.hostname === 'api.open-meteo.com', new NetworkFirst({
